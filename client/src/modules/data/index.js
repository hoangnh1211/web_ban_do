...
function Data() {
    ...
    return (
        <div className='row' style={{ marginLeft: '30px', marginRight: '30px' }}>
            <div className='col-4'>
                <h5>I. Hiện trạng hồ ngày:</h5>
                <ul>
                    <li>Mực nước hiện tại: (m)</li>
                    <li>Dung tích hiện tại: (triệu m&#xb3;)</li>
                    <li>Dung tích hữu ích: (m)</li>
                    <li>Mực nước hiện tại: (m)</li>
                    <li onClick={() => setShowThongTinHo(true)} style={{ cursor: "pointer" }}>Thông số cơ bản của hồ Phú Ninh: </li>
                    <li>Diện tích tích được tưới: 11.920 ha</li>
                </ul>
                <h5>III. Thông tin chung</h5>
                <ul>
                    <li onClick={() => setShowThongSo(true)} style={{ cursor: "pointer" }}>1.Vị trí công trình và các thông số kỹ thuật hồ Phú Ninh</li>
            ...
            {showThongTinHo && <Modal show={showThongTinHo} onHide={handleCloseThongTin}>
                <Modal.Header>
                    <Modal.Title>Thông số cơ bản của hồ Phú Ninh</Modal.Title>

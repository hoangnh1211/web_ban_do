...
export const congTrinhNangCap = new TileLayer({
    source: new TileWMS({
        ...
        params: {
            ...
            'VERSION': '1.1.1',
            "STYLES": '',
            "LAYERS": 'QuyHoachTL:Nangcap_ToanQuoc_V4',
            "exceptions": 'application/vnd.ogc.se_inimage',
        }
    }),
    visible: false,
...
const ctht_cuulong = new TileLayer({
    source: new TileWMS({
        ratio: 1, tileSize: tileSize, serverType: 'geoserver', tilePixelRatio: 1,
        url: urlConfig,
        params: {
            ...
            'VERSION': '1.1.1',
            "STYLES": '',
            "LAYERS": 'cuulong:HienTrang_CuuLong',
            "exceptions": 'application/vnd.ogc.se_inimage',
        },
    }),
    visible: false,

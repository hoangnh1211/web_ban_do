...
function MenuLayer(props) {
    ...
    const renderDanhMuc = (data, callback) => {
        ...
        value =[{ id: 24, objectid: 24, tenlv: "QH Thiên tai - Thủy lợi Quốc gia" }, ...value]
        if (!props.getData){
            return (
                <div
                    style={{
        ...
        return value.map((option, i) => {
            return (
                <div className="form-check" onClick={()=>{props.handleSearch(`DanhMucQuyHoach.${option.id}`)}} style={{paddingTop:'5px', paddingBottom:'5px' ,borderBottom: '1px solid #000'}}>
                    <label className={option.check ? "form-check-label checkTrue" : "form-check-label"} id="a62">{option.tenlv}</label>
                </div>
            );
        });
    }
        ...
        <div id="menuLayer">
            ...
            <div className="flex">
                ...
                <div className="dropdown">
                    ...
                    >
                        <b>
                            ...
                            <span
                                style={{ marginLeft: '5px', fontSize: '14px', fontFamily: 'Manrope, Roboto, Helvetica, Arial, sans-serif' }}
                            // onClick={()=>{setListThuyHe({...listThuyHe, show:!listThuyHe.show, class:!listThuyHe.show ? "fa-solid fa-caret-down" : "fa-solid fa-caret-right"})}}
                ...
                <div className="dropdown">
                    ...
                    >
                        <b>
                            ...
                            <span class="icon-layer"><input style={{ marginLeft: '5px' }} type="checkbox" value="" defaultChecked={showThuyLoi} id='a61' onChange={() => showAllThuyloi()} /></span>
                            <span style={{ marginLeft: '5px', fontSize: '14px', fontFamily: 'Manrope, Roboto, Helvetica, Arial, sans-serif' }} onClick={() => { setListThuyHe({ ...listThuyHe, show: !listThuyHe.show, class: !listThuyHe.show ? "fa-solid fa-caret-down" : "fa-solid fa-caret-right" }) }}>Thuỷ hệ</span>
                        </b>
                    </div>
                ...
                <div className="dropdown">
                    ...
                    >
                        <b>
                            <i class={dataDanhMuc.class} onClick={() => { setDataDanhMuc({ ...dataDanhMuc, show: !dataDanhMuc.show, class: !dataDanhMuc.show ? "fa-solid fa-caret-down" : "fa-solid fa-caret-right" }) }}></i>
                            <span style={{ marginLeft: '5px', fontSize: '14px', fontFamily: 'Manrope, Roboto, Helvetica, Arial, sans-serif' }} onClick={() => { setDataDanhMuc({ ...dataDanhMuc, show: !dataDanhMuc.show, class: !dataDanhMuc.show ? "fa-solid fa-caret-down" : "fa-solid fa-caret-right" }) }}>Các Quy hoạch thuỷ lợi</span>
                        </b>
                    </div>
                    {dataDanhMuc.show && <ul style={{ paddingTop: '0px !important' }} className={"dropdown__list " + 'dropdown__list--active'}>{renderDanhMuc(dataDanhMuc, setDataDanhMuc)}</ul>}
                </div>
                <div className="dropdown">
                    <div
                        className="dropdown__toggle dropdown__list-item"
                    >
                        <b>
                            ...
                            <span class="icon-layer"><input style={{ marginLeft: '5px' }} type="checkbox" value="" defaultChecked={showCongTrinh} id='a61' onChange={() => showAllCongTrinh()} /></span>
                            <span style={{ marginLeft: '5px', fontSize: '14px', fontFamily: 'Manrope, Roboto, Helvetica, Arial, sans-serif' }} onClick={() => { setListCongTrinhQuyHoach({ ...listCongTrinhQuyHoach, show: !listCongTrinhQuyHoach.show, class: !listCongTrinhQuyHoach.show ? "fa-solid fa-caret-down" : "fa-solid fa-caret-right" }) }}>Dữ liệu quy hoạch</span>
                        </b>
                    </div>

    ...
    return (
        ...
        <div className="panel ind mt" id="mt">
            <div className="title-section">
                <h2 className="switch-lang" e="Library">Dữ liệu môi trường nước mặt</h2>
            </div>
            <div className="title-section" id='bando' onClick={changeShow}>
                <label className="switch-lang" e="Library">Bản Đồ <i className="fas fa-angle-double-left"></i></label>
            </div>
            <div className='row'>
                ...
                {check[0] && <div className="col-md-9 col-sm-9">
                    ...
                    <p className="al"><i>Bảng 1 : Vị trí và tọa độ lấy mẫu</i></p>
                    ...
                    <p className="al"><i>Bảng 2 Hàm lượng kim loại trong mẫu nước biển tại Hạ Long</i></p>
                    ...
                    <p>b)</p>
                    <p className="al"><i>Hình 1: Nồng độ các kim loại trong mẫu nước mặt ven bờ thành phố Hạ Long a) Chì và Thủy Ngân; b) Tổng Crom, Asen, Đồng và Kẽm</i></p>
                    ...
                    <p className="al"><i>Hình 2: Nồng độ các chất thuốc bảo vệ thực vật trong mẫu thu thập được</i></p>



                </div>}

                {check[1] && <div className="col-md-9 col-sm-9">
                    ...
                    <p className="al"><i>Bảng 2 Hàm lượng kim loại trong mẫu nước biển tại Vân Đồn</i></p>
                    ...
                    <p>b)</p>
                    <p className="al"><i>Hình 1 Nồng độ các kim loại trong mẫu nước mặt ven bờ huyện Vân Đồn: a) Chì và Thủy Ngân; b) Tổng Crom, Asen, Đồng và Kẽm</i></p>
                    ...
                    <p className="al"><i>Bảng 3 Hàm lượng các thuốc bảo vệ thực vật trong mẫu nước biển tại Vân Đồn</i></p>
                ...
                {check[2] && <div className="col-md-9 col-sm-9">
                    ...
                    <p className="al"><i>Bảng 2: Hàm lượng kim loại trong mẫu nước biển tại huyện Hải H</i></p>
                    ...
                    <p>b)</p>
                    <p className="al"><i>Hình 4 Nồng độ các kim loại trong mẫu nước mặt ven bờ huyện Hải Hà: a) Chì và Thủy Ngân; b) Tổng Crom, Asen, Đồng và Kẽm</i></p>
                    ...
                    <p className="al"><i>Bảng 3 Hàm lượng các thuốc bảo vệ thực vật trong mẫu nước biển tại Hải H</i></p>
                    ...
                    <p className="al"><i>Hình 5: Nồng độ các chất thuốc bảo vệ thực vật trong mẫu nước mặt ven b</i></p>

                </div>}
                {check[3] && <div className="col-md-9 col-sm-9">
                    ...
                    <p className="al"><i>Hình 1: Hàm lượng chì trong nước mặt ven bờ khu vực cảng Hải Phòng năm 2021</i></p>
                    ...
                    <p className="al"><i>Hình 2: Hàm lượng thủy ngân trong nước mặt ven bờ khu vực cảng Hải Phòng năm 2021</i></p>
                    ...
                    <p className="al"><i>Hình 3: Hàm lượng Crom trong nước mặt ven bờ khu vực cảng Hải Phòng năm 2021</i></p>
                    <p className="al"><i>Bảng 1: Hàm lượng các kim loại nặng đo được vào mùa khô tại một số địa điểm ven bờ cảng Hải Phòng</i></p>
                    ...
                    <p className="al"><i>Bảng 3: Hóa chất bảo vệ thực vật quan trắc vào mùa khô vùng biển ven bờ cảng Hải Phòng (12-20/04/2021)</i></p>
                    ...
                    <p className="al"><i>Bảng 4: Hóa chất bảo vệ thực vật quan trắc vào mùa mưa vùng biển ven bờ cảng Hải Phòng (14-22/10/2021)</i></p>
                ...
                {check[4] && <div className="col-md-9 col-sm-9">
                    ...
                    <p className="al"><i>Bảng 1: Kết quả quan trắc mùa khô vùng biển ven bờ Cát Bà (16-24/04/2021</i></p>
                    ...
                    <p className="al"><i>Bảng 2: Kết quả quan trắc mùa mưa vùng biển ven bờ Cát Bà (14-22/10/2021)</i></p>
                    ...
                    <p className="al"><i>Hình 1: So sánh tổng hàm lượng hóa chất bảo vệ thực vật gốc Clo tại các điểm quan trắc ở Cát Bà năm 2020 và 2021</i></p>
                    ...
                    <p className="al"><i>Hình 2: So sánh tổng hàm lượng hóa chất bảo vệ thực vật gốc Phospho tại các điểm quan trắc ở Cát Bà vào mùa mưa và mùa khô năm 2021</i></p>
                    <p><b>Hóa chất bảo vệ thực vật nhóm Perythroid</b></p>
                    ...
                    <p className="al"><i>Bảng 3: Hóa chất bảo vệ thực vật quan trắc vào mùa khô vùng biển ven bờ Cát Bà (16-24/04/2021)</i></p>
                    ...
                    <p className="al"><i>Bảng 4: Hóa chất bảo vệ thực vật quan trắc vào mùa mưa vùng biển ven bờ Cát Bà (14-22/10/2021)</i></p>
                ...
                {check[5] && <div className="col-md-9 col-sm-9">
                    ...
                    <p className="al"><i>Hình 2: Hàm lượng As đo được tại 12 trạm quan trắc so với QCVN</i></p>
                    <p><b>Thủy ngân (Hg)</b></p>
                    ...
                    <p className="al"><i>Hình 3: So sánh tổng hàm lượng hóa chất bảo vệ thực vật tại 12 trạm ven bờ Thái Bình vào mùa khô và mùa mưa</i></p>
                    <p><b>Hóa chất bảo vệ thực vật gốc Phospho</b></p>
                    ...
                    <p className="al"><i>Hình 4: So sánh tổng hàm lượng hóa chất bảo vệ thực vật tại 12 trạm ven bờ Thái Bình vào mùa khô và mùa mưa</i></p>
                    <p><b>Hóa chất bảo vệ thực vật nhóm Perythroid</b></p>
                    ...
                    <p className="al"><i>Bảng 2: Kết quả quan trắc mùa khô vùng biển ven bờ Thái Bình (12-20/04/2021)</i></p>
                    ...
                    <p className="al"><i>Bảng 3: Kết quả quan trắc mùa mưa vùng biển ven bờ Thái Bình (14-22/04/2021)</i></p>
                    ...
                    <p className="al"><i>Bảng 4: Hóa chất bảo vệ thực vật quan trắc vào mùa khô vùng biển ven bờ Thái Bình (12-20/04/2021)</i></p>
                    ...
                    <p className="al"><i>Bảng 5: Hóa chất bảo vệ thực vật quan trắc vào mùa mưa vùng biển ven bờ Thái Bình (14-22/10/2021)</i></p>

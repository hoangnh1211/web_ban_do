...
function Image() {
    ...
    const image1 = ['https://firebasestorage.googleapis.com/v0/b/jlpt-80382.appspot.com/o/078b7a68577b9425cd6a.jpg?alt=media&token=6044b9a6-f583-4074-8ea6-7235948084b9']
    const image2 = ['https://firebasestorage.googleapis.com/v0/b/jlpt-80382.appspot.com/o/078b7a68577b9425cd6a.jpg?alt=media&token=6044b9a6-f583-4074-8ea6-7235948084b9']
    ...
    const image5 = ['https://firebasestorage.googleapis.com/v0/b/jlpt-80382.appspot.com/o/image%2FDangTriMua1971.jpg?alt=media&token=8279363b-e68d-4908-9d6a-69fb55a4f9d9',
    ...
    return (
        <div className="panel ind ">
            ...
            <div id="content">
                <div className='row' >
                    <div className='col-3'>
                        <img className="image_home" onClick={()=>showModal(image1)} src="https://firebasestorage.googleapis.com/v0/b/jlpt-80382.appspot.com/o/078b7a68577b9425cd6a.jpg?alt=media&token=6044b9a6-f583-4074-8ea6-7235948084b9"></img>
                        <p>Phạm vi nghiên cứu</p>
                    </div>
                    <div className='col-3'>
                        <img className="image_home" onClick={()=>showModal(image2)} src="https://firebasestorage.googleapis.com/v0/b/jlpt-80382.appspot.com/o/078b7a68577b9425cd6a.jpg?alt=media&token=6044b9a6-f583-4074-8ea6-7235948084b9"></img>
                ...
                <div className='row' id="content">
                    <div className='col-3' >
                        <img className="image_home" onClick={()=>showModal(image5)} src="https://firebasestorage.googleapis.com/v0/b/jlpt-80382.appspot.com/o/image%2FDangTriMua1971.jpg?alt=media&token=8279363b-e68d-4908-9d6a-69fb55a4f9d9"></img>
